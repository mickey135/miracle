  ...
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="{{url('admin/add')}}"> 添加内容</a> </li>
        <li>搜索：</li>
          <li>
            <select name="cid" class="input" style="width:200px; line-height:17px;">
              <option value="">电影名</option>
              <option value="">演员名</option>
            </select>
          </li>
        <li>
    ...
    @foreach($movie as $v)
        <tr>
          <td style="text-align:left; padding-left:20px;">{{$v->movie_id}}</td>
          <td>{{$v->movie_name}}</td>
          <td>{{$v->time}}</td>
          <td>{{$v->updated_at}}</td>
